...
public class TbCartDaoTest {
    ...
    {
        List<TbCart> tbCarts =cartDao.selectByUserId("000002");
        System.out.println("***************************");
    ...
    @Test
    public void  selectByUserIdAndBeChose()
    {
        List<TbCart> carts=cartDao.selectByUserIdAndBeChose("000002");
